 ...
 * @param {Number} [jobRetryDelay]
 * @constructor
 */
function JobManager(jobDirectory, tempFilesDir, handlers, jobRetryDelay) {
  ...
  this._processor = new JobProcessor(tempFilesDir, jobRetryDelay);

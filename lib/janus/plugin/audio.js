...
PluginAudio.prototype.isValidMessage = function(message) {
  if (PluginAudio.super_.prototype.isValidMessage(message)) {
    return 'message' != message['janus'] || !_.contains(['list', 'exists', 'resetdecoder', 'listparticipants'], message['body']['request']);
  } else {
    return false;
  }
};

 ...
 * @returns {Object}
 */
PluginStreaming.prototype.getContext = function() {
  var context = new Context();
  context.extend(PluginStreaming.super_.prototype.getContext.call(this));
  if (this.stream) {
    context.extend(this.stream.getContext());
  }
